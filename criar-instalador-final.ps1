# Script Final para Criar Instalador do CoterapIA
# Este script cria um instalador sem dependencias externas

Write-Host "=== COTERAPIA - CRIADOR DE INSTALADOR FINAL ===" -ForegroundColor Magenta
...
# 5. Build do Tauri (apenas executavel, sem bundle)
...
# 9. Pular modelos Vosk (não incluídos)
Write-Host "`n9. Pulando modelos Vosk (não incluídos no instalador)..." -ForegroundColor Yellow
Write-Host "   Modelos Vosk não serão incluídos" -ForegroundColor Cyan

# 10. Pular bibliotecas Vosk (não incluídas)
Write-Host "`n10. Pulando bibliotecas Vosk (não incluídas no instalador)..." -ForegroundColor Yellow
Write-Host "   Bibliotecas Vosk não serão incluídas" -ForegroundColor Cyan
...
- Todas as bibliotecas necessarias do Whisper
