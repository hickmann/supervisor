...
const osInstructions: Record<string, Instructions> = {
  macos: {
    ...
    description:
      "CoterapIA needs permission to capture your screen's audio. Clicking the button will open System Settings.",
    buttonText: "Open System Settings",
    manualTitle: "If permission is not granted automatically:",
    manualSteps:
      "1. Go to System Settings > Privacy & Security > Screen & System Audio Recording.\n2. Find CoterapIA in the list and enable it, if not found then click on + and add CoterapIA.",
    note: "A restart of CoterapIA may be required after granting permission.",
  },
  windows: {
    title: "System Audio Access",
    description:
      "CoterapIA needs to access your system audio. The button below will open the Sound settings panel for troubleshooting.",
    buttonText: "Open Sound Settings",
    manualTitle: "To ensure CoterapIA can capture audio:",
    manualSteps:
  ...
  linux: {
    ...
    description:
      "CoterapIA captures audio using PulseAudio. Please ensure it is configured correctly.",
  ...
  undetermined: {
    ...
    description: "CoterapIA needs permission to capture system audio.",
    buttonText: "Grant Permission",
    manualTitle: "Manual Setup:",
    manualSteps:
      "Please check your system's privacy or sound settings to allow CoterapIA to capture audio.",
  },
};
